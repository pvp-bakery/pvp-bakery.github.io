	...
	jQuery.mbYTPlayer = {
		...
		buildPlayer: function (options) {
			return this.each(function () {
				...
				YTPlayer.isBackground = YTPlayer.opt.containment.get(0).tagName.toLowerCase() == "#home";
				...
				if (YTPlayer.isBackground) {
					jQuery("#home").css({position: "relative", minWidth: "100%", minHeight: "100%", zIndex: 1, boxSizing: "border-box"});
